...
4. **Canonical temperature state** — complete. Immutable assessment history is the sole persisted fact; current temperature is a deterministic bulk/read projection, and both Account-side copies are removed after a defensive backfill.
